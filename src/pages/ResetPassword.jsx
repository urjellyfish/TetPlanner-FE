...
function ResetPassword() {
  ...
  const handleUpdate = (e) => {
    ...
    // Giả lập thành công
    navigate("/reset-success"); // Quay về trang đăng nhập
  };
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 h-full">
        <div className="w-full max-w-md">
          ...
          >
            ...
            <button
              type="submit"
              className="w-[343px] h-[50px] mt-2 rounded-[10px] bg-[#E11D48] text-white font-semibold transition-all hover:opacity-90 active:scale-95 shadow-lg shadow-red-100"
            >
              UPDATE PASSWORD
            </button>
